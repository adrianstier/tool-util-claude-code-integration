                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    ...
                    <a
                      ...
                      className="flex items-center gap-1 rounded-lg bg-primary-700 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-800"
                    >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-primary-700 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300"
              >
