...
`archive/` holds superseded planning and handoff documents. They are kept for
their rationale, not as instructions — **do not treat anything in `archive/` as
a to-do list**. Each carries a dated note at the top explaining what replaced it.
