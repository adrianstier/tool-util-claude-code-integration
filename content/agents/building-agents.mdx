...
<VideoEmbed
  ...
  channel="AI Engineer"
  caption="Worth watching before you build anything: Anthropic's own advice on when a deterministic workflow beats an agent, and how to keep the agent core simple."
/>
