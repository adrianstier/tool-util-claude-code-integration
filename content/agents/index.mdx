...
Before you build one, it is worth checking whether you need one: the [agent or workflow?](/tools/agent-or-workflow) tool walks through the five questions that decide it.

<VideoEmbed
  id="CEvIs9y1uog"
  title="Don't Build Agents, Build Skills Instead"
  channel="AI Engineer"
  caption="A useful counterweight to this whole track: Anthropic's Barry Zhang and Mahesh Murag on why a skill often solves the problem an agent was reached for."
/>
