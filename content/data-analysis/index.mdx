...
{`flowchart LR
    foundation["Foundation<br/>Project setup<br/>Data import"]
    core["Core Skills<br/>Data cleaning<br/>Transformation<br/>Visualization"]
    advanced["Advanced<br/>Modeling<br/>Reporting"]

    foundation --> core --> advanced

    class foundation actor
    class core process
