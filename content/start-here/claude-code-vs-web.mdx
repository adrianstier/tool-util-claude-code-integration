...
<VideoEmbed
  ...
  channel="Mark Kashef"
  caption="Why the CLI behaves so differently from the chat window: it searches your codebase for the few lines it needs instead of pasting whole files into context."
/>
