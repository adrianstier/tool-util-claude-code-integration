...
order: 0
duration: '50 minutes'
# This landing page IS the tutorial for this track (no sub-articles).
selfContained: true
...
{`flowchart LR
    extract["Extract<br/>Call the API<br/>Fetch data<br/>Validate response"]
    transform["Transform<br/>Clean data<br/>Apply business logic<br/>Format output"]
    load["Load<br/>Write to database<br/>Generate report<br/>Send notification"]
