...
<VideoEmbed
  ...
  start="8:05"
  caption="Two minutes on treating CLAUDE.md as your project's memory, and on telling Claude to keep it updated as the project changes."
/>
...
<VideoEmbed
  ...
  channel="AI with Avthar"
  start="11:15"
  caption="Plan mode in practice — press Shift+Tab until the mode indicator changes, and Claude proposes a plan before touching any code."
/>
