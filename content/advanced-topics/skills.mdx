...
<VideoEmbed
  ...
  channel="Claude"
  caption="Anthropic's own three-minute explanation of the just-in-time loading model described above."
/>
...
<VideoEmbed
  id="nbqqnl3JdR0"
  title="How to Create Claude Code Agent Skills in 2026"
  channel="Code with Beto"
  caption="A skill built from an empty folder, covering the same frontmatter and file layout described in this section."
/>
