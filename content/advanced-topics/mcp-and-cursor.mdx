...
{`flowchart LR
    exploration["1. Explore<br/>Claude Code + MCP<br/>Query database<br/>Search codebase"]
    development["2. Develop<br/>Cursor IDE<br/>Inline edits<br/>Multi-file changes"]
    integration["3. Integrate<br/>Claude Code<br/>Git operations<br/>Deploy"]

    exploration --> development --> integration

    class exploration actor
